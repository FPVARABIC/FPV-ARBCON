...
function NumericField({label, value, min, max, disabled, onChange, testID}: {label: string; value: number; min: number; max: number; disabled: boolean; onChange: (value: number) => void; testID: string}) {
  return <View style={styles.numericField}>
    ...
    <View style={styles.stepper}>
      <Pressable disabled={disabled || value <= min} onPress={() => onChange(Math.max(min, value - 1))} style={styles.stepButton} testID={`${testID}-minus`}><Text style={styles.stepText}>−</Text></Pressable>
      <TextInput value={String(value)} editable={!disabled} keyboardType="number-pad" onChangeText={text => { const parsed = Number(text.replace(/[^0-9]/g, '')); if (Number.isFinite(parsed)) onChange(parsed); }} onBlur={() => onChange(Math.min(max, Math.max(min, value)))} style={styles.numberInput} accessibilityLabel={label} testID={testID} />
      <Pressable disabled={disabled || value >= max} onPress={() => onChange(Math.min(max, value + 1))} style={styles.stepButton} testID={`${testID}-plus`}><Text style={styles.stepText}>+</Text></Pressable>
    </View>
...
const styles = StyleSheet.create({
  ...
  signalSummary: {flexDirection: 'row', justifyContent: 'center', alignItems: 'center', gap: spacing.sm, flexWrap: 'wrap'}, signalLabel: {...typography.caption, color: colors.textMuted}, signalValue: {...typography.body, color: colors.accentStrong, fontWeight: '800', fontVariant: ['tabular-nums']},
  ...
  providerRow: {flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: spacing.md, flexWrap: 'wrap'}, fieldLabel: {...typography.caption, color: colors.textMuted, textAlign: 'right'}, providerValue: {...typography.heading, color: colors.accentStrong, textAlign: 'left'}, secondaryButton: {minHeight: 42, justifyContent: 'center', paddingHorizontal: spacing.md, borderRadius: radii.md, borderWidth: 1, borderColor: colors.accentStrong, backgroundColor: colors.accentSoft}, secondaryButtonText: {...typography.body, color: colors.accentStrong, fontWeight: '700'},
  mapRow: {flexDirection: 'row', gap: spacing.sm, flexWrap: 'wrap', alignItems: 'center'}, mapInput: {minWidth: 150, minHeight: 46, borderWidth: 1, borderColor: colors.border, borderRadius: radii.md, backgroundColor: colors.backgroundRaised, color: colors.textPrimary, paddingHorizontal: spacing.md, textAlign: 'center', fontWeight: '800', letterSpacing: 2}, invalidInput: {borderColor: colors.error, borderWidth: 2}, preset: {minHeight: 42, justifyContent: 'center', paddingHorizontal: spacing.md, borderRadius: radii.md, backgroundColor: colors.surfaceRaised}, presetText: {...typography.caption, color: colors.accentStrong, fontWeight: '700'},
  fieldsGrid: {flexDirection: 'row', flexWrap: 'wrap', gap: spacing.md}, numericField: {flexGrow: 1, flexBasis: 190, gap: 5}, stepper: {flexDirection: 'row', alignItems: 'stretch', minHeight: 44}, stepButton: {width: 42, alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: colors.border, backgroundColor: colors.backgroundRaised}, stepText: {fontSize: 20, color: colors.accentStrong, fontWeight: '700'}, numberInput: {flex: 1, minWidth: 70, borderTopWidth: 1, borderBottomWidth: 1, borderColor: colors.border, backgroundColor: colors.surface, color: colors.textPrimary, textAlign: 'center', fontVariant: ['tabular-nums'], fontWeight: '700'}, rangeHint: {...typography.caption, color: colors.textMuted, textAlign: 'center'}, toggleRow: {flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: spacing.md}, toggleCopy: {flex: 1, gap: 3},
  warning: {borderRadius: radii.md, borderWidth: 1, borderColor: colors.warning, backgroundColor: '#FFF7E7', padding: spacing.md, gap: spacing.sm}, warningText: {...typography.body, color: colors.warning, textAlign: 'right', writingDirection: 'rtl'}, danger: {borderRadius: radii.md, borderWidth: 1, borderColor: colors.error, backgroundColor: '#FFF0F2', padding: spacing.md, gap: 3}, dangerTitle: {...typography.heading, color: colors.error, textAlign: 'right'}, dangerText: {...typography.body, color: colors.error, textAlign: 'right', writingDirection: 'rtl'}, success: {borderRadius: radii.md, borderWidth: 1, borderColor: colors.success, backgroundColor: '#E8F8F1', padding: spacing.md}, successText: {...typography.body, color: colors.success, textAlign: 'right'}, inlineAction: {alignSelf: 'flex-start', minHeight: 40, justifyContent: 'center', paddingHorizontal: spacing.md, borderRadius: radii.md, backgroundColor: colors.warning}, inlineActionText: {...typography.body, color: colors.white, fontWeight: '700'}, loading: {...typography.body, color: colors.textSecondary, textAlign: 'center', padding: spacing.xl}, bottomSpace: {height: spacing.xl},
});
