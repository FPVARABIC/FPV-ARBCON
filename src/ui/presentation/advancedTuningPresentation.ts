...
export const RPM_FILTER_COPY = Object.freeze({
  title: 'مرشّح RPM',
  hint: 'يقرأ التطبيق هذه القيم ولا يكتبها في هذه المرحلة.',
  readOnlyReason:
    'حقول مرشّح RPM موجودة في ذيل الرسالة الذي لا يظهر إلا من إصدار MSP 1.48، '
    + 'وعدد أوزانه متغيّر. كتابة عقد لم نُثبته على كل الإصدارات كانت ستعني '
    + 'إرسال أصفار على لوحة لا تحمل هذه الحقول أصلًا.',
  unavailable:
    'لا يعرض هذا المتحكم حقول مرشّح RPM على إصدار MSP الحالي. هذا حدّ الإصدار، '
    + 'وليس قيمة صفر.',
});
