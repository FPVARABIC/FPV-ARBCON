...
/**
 * The code/comment splitter moved to `__testUtils__/sourceSplit` so the
 * PID legacy sweep could use it without importing - and re-running - this
 * entire suite. It is re-exported here because the splitter's own unit
 * tests live at the bottom of this file, beside the walls they protect.
 */
export {splitCodeAndComments} from './__testUtils__/sourceSplit';
