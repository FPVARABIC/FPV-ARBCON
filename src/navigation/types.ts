 ...
 * inside the 'Setup' route's shell (MainTabsScreen), alongside Setup and
 * the not-yet-implemented Ports/Receiver/PID tabs - see navigation/tabs.ts
 * for that set. It was previously typed here but registered only when the
 * build-variant seam supplied a component; both the seam and the separate
 * route are gone.
 *
