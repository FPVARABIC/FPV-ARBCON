...
**المنصات المعتادة:** 5" على 6S (المعيار) · 5" على 4S.
...
|---|---|---|
| 5" على 6S — منصة هذا الدليل | DSHOT600 · Dynamic Idle 40 · سقف فلتر 650 · `tpa_rate = 70` | S1.9 |
| 5" على 4S | نفس الأرقام؛ الفارق في اختيار المحرك والمروحة لا في الإعداد | S1.9 |

> **هذا الدليل مكتوب للسباق بمقاس 5 إنش.** لا تنسخ أرقامه إلى وووب
> 1S داخلي: الإعداد الرسمي لذلك العتاد يستعمل **Dshot300** لا
> DSHOT600، و`motor_poles = 12`، وأرضية دوران **120** بدل 40 — أي
> ثلاثة أضعاف — وأقصى جهد خلية 4.45V. ويوصي ببناء 48kHz لا 96kHz،
> ويقول إن 96kHz يقلّل السيطرة بفارق كبير (S1.8). **الوووب ليس سباقًا
> مصغّرًا، وهو ليس منصة هذا الدليل.**
...
### الخطوة 7 — مرسل الفيديو — قناتك ووضع الانتظار

**أين:** مرسل الفيديو · القناة والطاقة

**الموصى به:** 2 خيار محدَّد · 1 مفتاح مفعّل

![مرسل الفيديو — قناتك ووضع الانتظار — مرسل الفيديو · القناة والطاقة](images/7-vtx.png)

في السباق **النطاق والقناة ليسا اختيارك**، بل ما يخصصه لك المنظّم — واللقطة تعرض `Raceband` كمثال على ذلك، لا كتوصية. الحقل الذي يخصّك فعلًا هو **Pit Mode**: مفعّل هنا، أي أن المرسل صامت وأنت على خط الانطلاق، فلا تفسد فيديو من يطير الآن. أطفئه عند دورك. الجدول كله مقروء من متحكم الطيران، فما تراه هو ما يدعمه مرسلك أنت.
...
|---|---|---|---|
| ترددا القطع (setpoint · الخانق) | **اتركه كما هو** | اتركهما 0. إعداد السباق الرسمي يخفض المعاملين التلقائيين إلى 25 بدل استعمال ترددات قطع ثابتة. | S1.13 |
| Rates | **تفضيل الطيار** | لا توجد Rates رسمية باسم «سباق». المكتبة تعرض ملفات مؤلفين كخيارات لا كقاعدة. المبدأ: expo أقل من الحر، لأن الدقة حول المنتصف أهم من مدى الطرف — والرقم يبقى اختيارك. | — |
| قيم PID (P · I · D) | **اتركه كما هو** | إعداد السباق الرسمي يضبط PID عبر منزلقات simplified ثم `simplified_tuning apply`، وهي غير معروضة في التطبيق. لا تحاكِ النتيجة بتعديل P/I/D يدويًا. | S1.9 |
| الفلاتر (Gyro LPF · D-term LPF · Dynamic Notch) | **اتركه كما هو** | اتبع حزمة الضبط. القيم المرجعية (سقف 650Hz، أدنى 125Hz لبناء نظيف) في قسم «اختياري». | S1.9 |
| الأوضاع (Modes) | **تفضيل الطيار** | مفتاح ARM إلزامي. Turtle مفيد في السباق؛ بقية الأوضاع تفضيلك. | — |
| الطاقة والبطارية | **تفضيل الطيار** | اضبطها على حزمتك. السباق لا يفرض حدود بطارية، لكن تحذير الخلية يجب أن يصلك قبل نهاية اللفة لا بعدها. | — |
| `thrust_linear` · `tpa_*` | **لا ينطبق** | يضبطهما الإعداد الرسمي (thrust_linear 20 · tpa_rate 70 · tpa_breakpoint 1250) ولا يعرضهما هذا التطبيق. | S1.9 |
