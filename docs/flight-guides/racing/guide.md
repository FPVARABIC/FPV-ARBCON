...
| تنعيم الراديو (المعامل التلقائي) | **25** `[A]` (S1.4) | أقل تنعيم = أقل تأخير | رابطك أبطأ من 500Hz → ارفعه |
| تنعيم الخانق | **25** `[A]` (S1.4) | الوحيد بين الأنماط الذي يخفض تنعيم الخانق أيضًا | — |
