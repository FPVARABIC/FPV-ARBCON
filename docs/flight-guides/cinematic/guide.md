...
- **Rates.** لا يوجد رقم رسمي «سينمائي». الاتجاه: أبطأ بوضوح من ملفك
  المعتاد، وexpo أعلى قليلًا لتنعيم المنتصف. `[C]`
...
| 5" بكاميرا HD | `thrust_linear = 30` · سقف الفلتر 400 Hz · Dynamic Idle 30 — مع قيم إحساس العصا في الجدول الإلزامي أعلاه | S1.10b + S1.1 |
...
|---|---|---|---|
| ترددا القطع (setpoint · الخانق) | **اتركه كما هو** | اتركهما 0 — أي «تلقائي». الإعداد السينمائي الرسمي يضبط المعاملين التلقائيين ولا يلمس ترددي القطع. | S1.13 |
| Rates | **تفضيل الطيار** | لا توجد Rates رسمية للسينمائي. اختر ملفًا أبطأ من ملفك المعتاد وارفع expo قليلًا لتنعيم المنتصف — ولا نفرض رقمًا واحدًا لهذا النمط. | — |
| قيم PID (P · I · D) | **اتركه كما هو** | الإعدادان السينمائيان الرسميان لا يلمسان P أو I أو D إطلاقًا. النعومة تأتي من إحساس العصا والتنعيم، لا من خفض PID. | S1.1 |
| الفلاتر (Gyro LPF · D-term LPF · Dynamic Notch) | **اتركه كما هو** | اتبع ضبط منصتك. القيم المرجعية للسينمائي (سقف 750Hz لـ Cinelog، أدنى 125Hz لبناء نظيف) في قسم «اختياري»، والتطبيق لا يعدّلها إلا إذا أثبتت القراءة أن الميزة نشطة. | S1.11a |
| الأوضاع (Modes) | **تفضيل الطيار** | مفتاح ARM إلزامي ويُضبط مرة واحدة لكل طائرة. ما بعده — Angle أو Beeper أو Turtle — تفضيلك. | — |
| الطاقة والبطارية | **تفضيل الطيار** | لا توجد حدود بطارية «سينمائية». اضبطها على حزمتك أنت: عدد الخلايا، وتحذير الخلية، والسعة. | — |
| مرسل الفيديو (VTX) | **لا ينطبق** | لا يغيّره هذا النمط. اضبط القناة والطاقة مرة واحدة حسب مكانك وقوانينه. | — |
| `thrust_linear` | **لا ينطبق** | يضبطه الإعداد الرسمي حسب تردد ESC (0 عند 24k · 20 عند 48k · 40 عند 96k)، ولا يعرضه هذا التطبيق. يُضبط من سطر الأوامر أو بتطبيق الحزمة. | S1.11a |
