...
| تنعيم الراديو (المعامل التلقائي) | **50** `[A]` (S1.3) | وسط بين نعومة التصوير وحدّة السباق | — |
| تنعيم الخانق | **50** `[A]` (S1.3) | — | — |
...
| اضبط | ابدأ بـ | لماذا | غيّرها إذا |
|---|---|---|---|
| دفعة الاستجابة (Boost) | **0** `[A]` (S1.3) | الإعداد الرسمي للحر لا يضبطها | رابطك ELRS 250Hz فأعلى → 18 (S1.10b) |
...
![شاشة المحركات](../_shared/images/motors-session.png)
